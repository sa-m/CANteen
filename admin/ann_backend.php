<?php
	...
	if(isset($_POST['readrecord'])){
		...
		<?php
		$date=date("Y/m/d");
		$displayquery="SELECT * FROM ann_menu where date='$date' ";
	...
	if(isset($_POST['specialdish1']) && isset($_POST['price1']) && isset($_POST['specialdish2']) && isset($_POST['price2']) && isset($_POST['breakfast']) && isset($_POST['price3']))
	{
		...
		{
			$query="INSERT INTO `ann_menu`(`date`,`specialdish1`, `price1`, `specialdish2`, `price2`, `breakfast`, `price3`) VALUES ('$date','$specialdish1','$price1','$specialdish2','$price2','$breakfast','$price3')";
	...
	{
		$date=date("Y/m/d");
		$displayquery="DELETE FROM ann_menu where date='$date'";
		$result=mysqli_query($conn,$displayquery);
	}
?>